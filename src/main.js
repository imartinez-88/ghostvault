...
window.onload = function() {
    ...
    // UNLOCK PAGE Biometric + Pattern Access LOGIC
    ...
    if (unlockBtn) {
        unlockBtn.onclick = async () => {
            ...
            // NOTE: This logic still uses document.getElementById("vaultFile").files[0].
    ...
    if (registerBtn) {
        registerBtn.onclick = async () => {
            ...
            try {
                ...
                if (!credential) { alert("No credential created."); return; }
